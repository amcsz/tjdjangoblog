...
SECRET_KEY = 'django-insecure-8x09nd!ugu#=hc6mimr-ysukxks0bs0z@iguouducs96($b%ws'
...
INSTALLED_APPS = [
    ...
    'social_django',
    'djangoblog.apps.blog',
    'djangoblog.apps.oauth',
]
...
AUTHENTICATION_BACKENDS = ['djangoblog.apps.oauth.backend.IonOauth2', 'django.contrib.auth.backends.ModelBackend']
